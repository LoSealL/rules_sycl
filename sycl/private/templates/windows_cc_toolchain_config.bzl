...
def _impl(ctx):
    ...
    if _use_msvc_toolchain(ctx):
        sycl_compile_flag_feature = feature(
            name = "sycl_compile_flag",
            flag_sets = [
                flag_set(
                    actions = all_link_actions + [ACTION_NAMES.cpp_compile],
        ...
        fastbuild_feature = feature(
            ...
            flag_sets = [
                ...
                flag_set(
                    ...
                    flag_groups = [
                        flag_group(
                            flags = [ctx.attr.fastbuild_mode_debug_flag, "/Od", "/INCREMENTAL:NO"],
                        ),
                    ],
                ),
            ],
