...
def _write_builtin_include_directory_paths(repository_ctx, cc, directories, file_suffix = ""):
    ...
    if get_env_var(repository_ctx, "BAZEL_IGNORE_SYSTEM_HEADERS_VERSIONS", "0", False) == "1":
        repository_ctx.file(
            "toolchain/builtin_include_directory_paths" + file_suffix,
...
def configure_unix_toolchain(repository_ctx, paths, cpu_value, overriden_tools):
    ...
    repository_ctx.symlink(
        ...
        "toolchain/armeabi_cc_toolchain_config.bzl",
    )
